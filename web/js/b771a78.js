var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow, id) {
            ...
            jqTds[5].innerHTML = '<a class="edit btn btn-xs green" data-id="'+id+'" data-html="Save" href=""><i class="fa fa-save"></i> Valider</a>';
            jqTds[6].innerHTML = '<a class="cancel btn btn-xs red" data-id="'+id+'" href=""><i class="fa fa-times"></i> Annuler</a>';
        }
        ...
        function saveRow(oTable, nRow, id) {
            ...
            oTable.fnUpdate('<a class="edit btn btn-xs blue" data-id="'+id+'" href=""><i class="fa fa-edit"></i> Editer</a>', nRow, 5, false);
            oTable.fnUpdate('<a class="delete btn btn-xs red" data-id="'+id+'" href=""><i class="fa fa-times"></i> Supprimer</a>', nRow, 6, false);
            oTable.fnDraw();
        }
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({ // define ajax settings
					"url": "/admin/fabrication/fournisseur/delete", // ajax URL
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                $.ajax({ // define ajax settings
                        ...
                        "data":{
							...
							fax:jqInputs[3].value,
							adress:jqInputs[4].value
                        },
						success: function(data){
